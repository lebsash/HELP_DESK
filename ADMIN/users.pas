...
begin
 ...
 Form5.Edit3.Text:='';
 Form5.Memo1.Clear;
 Form5.ComboBox1.Text:='Неактивна';
 Form5.Caption:='Help_DESK - добавление фирмы';
...
begin
 ...
 // Ловим идентификатор, на котором нажата кнопка и передаем в окно редактирования
  ...
  form5.Memo1.Text:=IBQuery1OTHER.AsString;
   Form5.Caption:='Help_DESK - редактирование фирмы';
  ...
  if NOT IBQuery1.Eof then
    begin
     ...
     if length(IBQuery4USLOGIN.AsString)>0 then begin
                                                  // Обращаемся к помойке за координатой автологина
                                                   IBQuery6.SQL.Clear;
